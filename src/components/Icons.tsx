...
// icon:globe | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
...
// icon:map | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
export function ExclamationTriangleFillIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" {...props}>
...
export function BoxArrowUp(props: React.SVGProps<SVGSVGElement>) {
  return (
